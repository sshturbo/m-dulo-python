...
print_centered "Baixando modulos..."
sudo wget --timeout=30 -P /opt/myapp/ https://github.com/sshturbo/m-dulo-python/raw/main/m-dulo.zip &>/dev/null
...
sudo unzip /opt/myapp/m-dulo.zip -d /opt/myapp/ &>/dev/null && sudo rm /opt/myapp/m-dulo.zip
progress_bar 5
